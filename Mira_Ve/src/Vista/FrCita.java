 ...
 * @author jorge
 */
public class FrCita extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrCita.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
