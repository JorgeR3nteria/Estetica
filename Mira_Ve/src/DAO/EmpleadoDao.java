...
public class EmpleadoDao implements CRUD<EmpleadoDto>
{
        ...
        private static final String LEER = "SELECT * FROM empleado WHERE id_empleado=?";
        ...
        EmpleadoDto e = null;
            ...
            try 
            {
             ...
             res = stat.executeQuery();
                ...
                while (res.next()) 
                     {
                      e = new EmpleadoDto(res.getInt(1), res.getInt(2),res.getString(3), res.getString(4), res.getString(5), res.getDate(6), res.getString(7), res.getString(8), res.getInt(9), res.getInt(10));
                     }
                      return e;
            } catch (SQLException ex) 
                {
            ...
            try 
                {
                 ...
                 res = stat.executeQuery();
                    ...
                    while (res.next()) 
                        {
                         empleado.add(new EmpleadoDto(res.getInt(1), res.getInt(2),res.getString(3), res.getString(4), res.getString(5), res.getDate(6), res.getString(7), res.getString(8), res.getInt(9), res.getInt(10)));
                        }
                } catch (SQLException ex) 
                    {
                     Logger.getLogger(EmpleadoDao.class.getName()).log(Level.SEVERE, null, ex);
